...
<div class="center-page">
    <div class="card card-narrow mt-2">
        ...
        <form action="<?= BASEURL ?>/MasterData/updateAlternatif" method="post">
            <!-- ID hidden -->
            ...
            <div class="form-group">
                ...
                <input type="text" id="gambar" name="gambar" class="input"
                    value="<?= htmlspecialchars($data['gambar'] ?? '') ?>" placeholder="misal: bayam.jpg">

                <?php if (!empty($data['gambar'])): ?>
                    <div class="img-preview-wrapper">
                        <small>Gambar saat ini:</small><br>
                        <img src="<?= BASEURL ?>/assets/img/alternatif/<?= htmlspecialchars($data['gambar']) ?>"
                            alt="Gambar Alternatif" class="img-preview">
                    </div>
                <?php endif; ?>
            </div>
